Shader "FlatKit/Stylized Surface With Outline" {
	Properties {
		...
		[Header(Fallback light direction (used if all light in the scene is baked))] _LightmapDirectionPitch ("[DR_LIGHTMAP_DIR]Pitch", Range(0, 360)) = 0
		...
		[Space(25)] _OutlineColor ("Outline Color", Vector) = (0.85023,0.85034,0.85045,0.85056)
